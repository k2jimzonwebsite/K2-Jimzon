...
- No gateway, automatic bank callback, customer self-verification, schema migration, Admin permission change, production deployment or real transfer was made.
