...
import { readConsignmentData } from '../../server/admin-bff/consignments.js'
...
export default async function handler(req, res) {
  ...
  try {
    return safeJson(res, 200, { ok: true, data: await readConsignmentData(authorized.client) })
  } catch {
    return safeJson(res, 503, { error: { code: 'CONSIGNMENTS_UNAVAILABLE' } })
  }
}
