...
import { readAdminCoupons } from '../../server/admin-bff/coupons.js'
...
export default async function handler(req, res) {
  ...
  try {
    return safeJson(res, 200, { ok: true, data: await readAdminCoupons(authorized.client) })
  } catch {
    return safeJson(res, 503, { error: { code: 'COUPONS_UNAVAILABLE' } })
  }
}
