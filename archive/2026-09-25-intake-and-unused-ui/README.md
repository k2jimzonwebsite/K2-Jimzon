...
The pre-correction workflow guide is also preserved at `originals/src/components/admin/master-workflow-graph/workflowData.js` (SHA-256 `96c58a7b4bc66ad2afd0595995312f4c609536948368222f3ddb11359eed8ead`). CI found that its quoted “Smart paste” toolbar action no longer existed after consolidation; the active guide now names “Scan box.”
...
Draft PR #14's first CI run passed both Vercel previews and critical SQL behavior, then failed one of 962 base tests: the workflow guide quoted the retired “Smart paste” toolbar button. The exact failing guide contract passed 9/9 locally after correcting the guide label. The corrected commit must receive a new CI run before this receipt can claim complete CI success.
