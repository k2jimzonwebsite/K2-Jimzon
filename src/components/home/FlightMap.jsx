...
const WAYPOINTS = {
  ...
  transit: {
    ...
    detail: 'Packed carefully to protect freshness on the way to Manila.',
    x: 355,
    y: 65,
  },
  manila: {
    id: 'manila',
    title: 'Manila Hub',
    subtitle: 'Checked in Manila',
    detail: 'Checked by hand in Manila and delivered to your doorstep.',
    x: 508,
    y: 190,
  },
}
