...
export default function InteractiveReveal({ beforeImage, afterImage }) {
  ...
  return (
    ...
    >
      ...
      {afterImage && (
        <div
          className="absolute inset-y-0 z-20 w-0.5 bg-paper shadow-[0_0_10px_rgba(0,0,0,0.35)]"
          style={{ left: `${pos}%`, transform: 'translateX(-50%)' }}
        >
          <div className="absolute top-1/2 left-1/2 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-paper text-navy shadow-card">
