...
export default function ChatFab() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 flex flex-col items-end gap-3 md:bottom-6 md:right-6">
      {open && (
        <div className="rise w-64 rounded-xl border border-line bg-cream/95 backdrop-blur-xl p-4 shadow-float">
          <p className="font-serif text-base font-semibold">Inquiries</p>
          ...
          <div className="mt-3 flex gap-2">
            <button className="flex-1 rounded-md bg-navy px-3 py-2 text-sm font-semibold text-white hover:bg-navy/90">
              Viber
            </button>
            <button className="flex-1 rounded-md border border-navy/20 px-3 py-2 text-sm font-semibold text-navy hover:bg-navy/5">
              Messenger
            </button>
          </div>
        </div>
