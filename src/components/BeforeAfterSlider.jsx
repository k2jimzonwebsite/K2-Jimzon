  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        <span className="absolute left-1/2 top-1/2 flex h-9 w-9 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-navy/15 bg-paper text-navy shadow-float">
      ...
      {/* Captions */}
      <span className="pointer-events-none absolute left-3 top-3 rounded-full bg-navy/85 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.1em] text-white">
        Sealed for export
      </span>
      <span className="pointer-events-none absolute right-3 top-3 rounded-full bg-paper/90 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.1em] text-navy ring-1 ring-navy/10">
        What's inside
      </span>
    </div>
  )
