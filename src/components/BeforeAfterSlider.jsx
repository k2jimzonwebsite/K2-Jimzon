  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="absolute left-[50%] top-[50%] flex h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-navy text-cream shadow-float transition-transform hover:scale-110 active:scale-95">
      ...
      {/* Captions */}
      <span className="pointer-events-none absolute left-3 top-3 rounded-full bg-navy/85 px-2.5 py-1 text-xs font-semibold uppercase tracking-[0.1em] text-cream">
        Sealed for export
      </span>
