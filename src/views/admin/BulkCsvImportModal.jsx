      ...
      <div className="bg-[#10141d] border border-white/10 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          >
            ...
            <p className="text-base font-medium text-white/80">Click to select a .csv file</p>
          ...
          {parsedData.length > 0 && !error && (
            <div>
              <p className="text-base font-semibold text-white/80 mb-3 flex items-center justify-between">
                Preview ({parsedData.length} rows detected)
                <span className="text-sm text-white/40 font-normal">Showing first 3 rows</span>
              </p>
