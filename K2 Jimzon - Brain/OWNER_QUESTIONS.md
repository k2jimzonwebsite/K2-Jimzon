...
**Pending owner-only decision for the later stock grant correction (25 September):** The original phase-one and `20260909023000` approvals below are complete and do not authorize this new payload. Codex has prepared `supabase/migrations/20260925_map017_stock_public_grant_revocation.sql`, SHA-256 `479BCCE8AFE8EEA68B7C89F85370F5EE06FC28268ADC7DF9BC155D236E88A94D`. It removes one extra broad EXECUTE permission from the public stock-reading function; explicit customer access remains. The emergency-only rollback is SHA-256 `61A929C103298F43DB96E819EF1C6E3E8DCBE7DEF61EAEC8161CBB26B6B5C470`. A 25 September read-only live check confirmed the exact grant state; local apply/replay/check/rollback rehearsal passed; a fresh encrypted application-database backup `current-pixplcjqivlfflickobf-2026-09-25T095512876Z-688de96720d7` passed an isolated restore and has a redacted local receipt. **Only owner action:** reply in this task either “I authorize the MAP-017 stock permission correction identified by SHA-256 479BCCE8AFE8EEA68B7C89F85370F5EE06FC28268ADC7DF9BC155D236E88A94D” or “Defer the stock correction.” Codex handles any backup refresh and recovery checks, maintenance-window execution, live verification and rollback if needed. Approval here covers this one stock grant only, not the six guest grants, six provider-owned defaults, flags or a website release. No production SQL was applied in this preparation.
