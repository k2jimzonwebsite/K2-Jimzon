...
import { listProductIntakeConsignments } from '../../../server/admin-bff/product-intake.js'
...
export default async function handler(req, res) {
  ...
  try { return safeJson(res, 200, { ok: true, data: await listProductIntakeConsignments(authorized.client) }) }
  catch { return safeJson(res, 503, { error: { code: 'INTAKE_CONSIGNMENTS_UNAVAILABLE' } }) }
}
