...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { data, error } = await client.rpc(
      'list_guest_conversations_v1', signedRpcArguments(req, 'guest_read', {})
    )
    ...
    return safeJson(res, 200, { ok: true, conversations: mapped.result.conversations || [] })
  } catch {
    return safeJson(res, 503, { error: { code: 'MESSAGE_SERVICE_UNAVAILABLE' } })
  }
}
