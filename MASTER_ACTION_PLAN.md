...
DEPLOYMENT/PROMOTION** decision: the aggregate release gate did not complete,
Vercel deployment IDs were not obtained, and provider, recovery, authenticated
staff/customer, search and physical-device gates remain open. Do not interpret
